...
do
{
 ...
 printf("\n 7: Add a node before a given node");
 printf("\n 8: EXIT");
 ...
 break;
 case 7: start = insert_before(start);
 break;
 case 8: printf("Ending the program");
 break;
 }
}while(option !=8);
//getch();
...
if(i==1)
{
	printf("value %d found in list",num);
}
else
{
	printf("value %d is not found in list",num);
}
return start;
}
//----------------------------------------------------------------------------------//
